...
The study addressed three research questions. RQ1 asked whether players can identify a teammate's heart rate state and heart rate variability state from the animated icon alone, without numbers or emotion words. RQ2 asked whether the two visual channels carry the graded social meaning they were designed to carry, that is, whether activation reads as urgency and arousal and whether declining ring coherence reads as lower stability and a stronger call for support. RQ3 asked whether the display is clear and light enough in workload to be usable during cooperative play.

Five hypotheses followed. H1 held that identification accuracy for both the heart rate state and the variability state would exceed the 25 percent chance level of a choice among four options. H2 held that perceived urgency and arousal would rise monotonically with the heart rate state. H3 held that perceived stability would fall as ring coherence declined across the variability states. H4 held that the intention to offer support would rise as ring coherence declined. H5 held that the display would register low workload on the Task Load Index while returning high clarity and coordination usefulness.
