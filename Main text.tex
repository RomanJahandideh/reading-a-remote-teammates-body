...
\acmConference[SIGGRAPH  '2026]{SIGGRAPH 2026}{July 19--23,
  2026}{Los Angeles}
%%
...
{\small Option Chosen: Option 1 -- Research, Creation or Speculative Design Proposal and Literature Review Essay}\\
{\small Instructor: Dr.\ Gabriela Aceves-Sep\'ulveda}
}

\renewcommand{\shortauthors}{Jahandideh}
...
\renewcommand{\shortauthors}{IAT803 G100 Science, Technology & Culture}

%%
%% The abstract is a short summary of the work to be presented in the
%% article.
\begin{abstract}
This paper presents Physiological Legibility, a research-creation and speculative design project that explores how shared physiological sensing can reshape coordination in multiplayer digital games. The project investigates how heart rate (HR) and heart rate variability (HRV) data collected from Apple Watch devices can be translated into a multiplayer user interface that makes teammates’ physiological conditions partially visible during cooperative play. Rather than displaying biosignals as numbers or explicit emotional labels, the proposed system classifies HR and HRV into a small set of interface states and maps them onto visual changes in each player’s avatar icon. Players can interpret physiological signals as ambient coordination cues during moments of uncertainty, poor synchronisation, or collaborative breakdown since these states are communicated through subtle cues as pulsating auras, altering ring density, and variations in icon stability.
The project deviates from interface designs that primarily employ physiological data to control difficulty, maximise performance, or deduce emotional truth. Rather, it views biosignals as signals contained in interaction that are context-dependent and socially interpretable. In terms of methodology, the study develops a novel interface concept for cooperative play by combining research-creation, speculative design, literature assessment, and system design. Physiological Legibility, which proposes a multiplayer UI system that emphasises ambiguity, coordination, and interpretive accountability, advances research on biometric interfaces, game design, and human-computer interaction by redefining physiological data as a negotiable social cue rather than a transparent representation of inner state.
\end{abstract}
...
\section{Acknowledgment of Peer Review Feedback}
After receiving comments from peers during the course review process, this work was changed. The document was improved and numerous parts of the project were clarified thanks to the helpful feedback from Mr. Seyyed and Mrs. Wang. 
Mr. Seyyed recommended that the article clarify the connection between the design of the physiological interface and the theoretical framework derived from Science and Technology Studies. In response to this criticism, the updated manuscript makes a stronger connection between the artefact and ideas of measurement, classification, and technological mediation that have been explored by academics like \cite{nelson_meeting_1996,bowker_sorting_2008}. The Discussion section was also revised to provide a clearer explanation of how these theoretical viewpoints are reflected in the interface design.
Mrs. Wang suggested making the methodological explanation more understandable and giving a more thorough explanation of how physiological signals are converted into interface visual components. In response to this recommendation, the Methodology and System Design sections were enlarged to provide a more thorough explanation of the system architecture, the study creation methodology, and the procedure for integrating heart rate and heart rate variability data into the multiplayer interface.
The final version of the paper, therefore, incorporates these comments by strengthening the connection between theory and design, clarifying the methodological approach, and improving the explanation of the proposed interface system.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Acknowledgment of AI Tools}
An AI language model (ChatGPT) was utilised as a writing aid for language editing and text organising while this work was being prepared. The author created the initial textual content, conceptual framework, research idea, and artefact design. The text's early drafts, which were written by hand in a word processing program, have grammatical mistakes and an informal structure typical of a working draft. 
The main purpose of the AI technique was to rearrange these draft paragraphs into more understandable academic jargon. In actuality, the author instructed the AI system to reorganise the content into a more formal academic style while maintaining the original meaning after writing preliminary text outlining the study concepts, methodology, and design process.
A typical prompt used during this process was the following:
“Please reorganize the following draft text into a clear academic paragraph suitable for a research paper. Maintain the original ideas but correct grammar, improve clarity, and structure the writing in a formal academic style. Do not add new arguments or change the meaning of the text.”
Therefore, rather of being a source of research ideas or analysis, the AI technology was utilised as a language editing and structuring help. The author made all conceptual choices, interpretations, and final edits. Before adding any AI-assisted material to the final publication, the author made sure it was accurate and in line with the goals of the study.
